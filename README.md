...
1.Load the weather dataset and preprocess the data by cleaning column names and sorting by time.

2.Handle missing values using linear interpolation.

3.Perform feature engineering by extracting hour information and creating lag features for temperature, PM2.5, and solar radiation.

4.Split the dataset into training (80%) and testing (20%) sets.

5.Train a Random Forest Regressor model to predict temperature, PM2.5, and solar radiation.

6.Evaluate the model using R² score and Mean Absolute Error (MAE) and predict the next values using the latest data. 
...
## Result:
The Random Forest model successfully predicted temperature, PM2.5 pollution, and solar radiation using weather sensor data with good accuracy.
The system also generated next-step predictions and visual graphs comparing actual vs predicted values and showing feature importance.
